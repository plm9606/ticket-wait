...
import type { KopisSyncService } from "../application/sync/kopis-sync.service.js";
...
export function startScheduler(
  ...
  cron.schedule("0 0 * * *", async () => {
    ...
    const sent = await notificationService.sendTicketOpenReminders();
